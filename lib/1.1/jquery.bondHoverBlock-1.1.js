        ...
        function bindEvent() {
                ...
                if (windowScrollTop - options.topPosWindow >= positionBlock.top - options.topPosblock) {
                    if (!memory.isFix) {
                        ...
                        if (options.isCopy) {
                            ...
                            this$.stop().animate({opacity:localOpacity}, options.showSpeed, memory.effectShow);
                        }
                        else {
                    ...
                    if (memory.isFix) {
                        ...
                        if (options.isCopy) {
                            ...
                            this$.stop().animate({opacity:0}, options.hideSpeed, memory.effectHide, function () {
                                anyfunc();
                                this$.css({opacity:this$.data("opacity")});
                                this$.unwrap();
                            });
            ...
            if (options.opacityMouseOver) {
                this$.mouseenter(function (e) {
                    this$.stop().animate({opacity:this$.data("opacity")}, options.showSpeed, memory.effectShow);
                });
                this$.mouseleave(function (e) {
                    this$.stop().animate({opacity:options.opacityHide }, options.hideSpeed, memory.effectHide);
                });
            }
        }
